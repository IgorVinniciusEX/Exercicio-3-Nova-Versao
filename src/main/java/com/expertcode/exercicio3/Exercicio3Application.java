...
Para o sistema de veículos, crie três tabelas de Marca, Categoria e Veículo(id, nome, placa, marca). > ok

A marca tem um identificador incremental e nome da Marca. Ex: 1 - Fiat > ok
